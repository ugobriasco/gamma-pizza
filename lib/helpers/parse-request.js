    ...
    new Promise((resolve, reject) => {
      ...
      .then(payloadString => {
        ...
        if (headers["content-type"] == "application/x-www-form-urlencoded") {
          ...
          // handle canonical payload
          return payloadString == "" ? {} : JSON.parse(payloadString);
        }
      })
...
// Parse the http/s request in a consumable JSON object
const parseRequest = req =>
  getPayload(req).then(payload => ({
