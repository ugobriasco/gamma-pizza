    ...
    .then(req => {
      ...
      if (req.isVerified === false) {
        ...
        chosenHandler(req, response => {
          const { statusCode, data, contentType, headers } = response;
          ...
          // Write head with the given status code and headers
          res.writeHead(statusCode, headers);

          // Fetch payload and send response
          ...
          if (contentType == "html") {
            ...
            res.end(typeof data != "undefined" ? data : "");
          }
        });
      }
    })
